<!DOCTYPE html>
<html>
<title>Sai Ram HR services </title>
<meta charset="UTF-8">
...
.bgimg-1 {
  ...
  background-image: url("Human-Resources-Audit.jpg");
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-button w3-wide"><img border="0" alt="logo" src="srngoc logo.png" width="100" height="100"></a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Sai Ram Management, Manpower and HR</span><br>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    ...
    <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone: +91 9320058892</p>
    <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email: sairamnaturalgas@gmail.com</p>
    <br>
...
<footer class="w3-center w3-black w3-padding-64">
  ...
  <p>Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-text-green">The Box AI</a></p>
</footer>
